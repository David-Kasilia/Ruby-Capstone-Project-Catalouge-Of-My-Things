...
describe Label do
  before(:each) do
    ...
    @book_one = Books.new('The Originals', 'Julie Pleck', Time.new(2013, 10, 0o3), 'best')
    @book_two = Books.new('Bel Air', 'Will Smith', Time.now, 'best')
    @book_three = Books.new('After', 'Hardan', Time.now, 'bad')
    @book_four = Books.new('Teen Wolf', 'Scott Mcall', Time.new(2014, 10, 10), 'good')
    @book_five = Books.new('Purple Hearts', 'Tessa', Time.new(2012, 10, 16), 'bad')
